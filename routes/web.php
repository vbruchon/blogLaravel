...
Route::get('/dashboard/post/{post}/comments', [AdminCommentController::class, 'index'])->name('dashboard.post.comments');

//Dashboard Comments Page By Post -> show an comment
Route::get('/dashboard/post/{post}/comments/{comment}', [AdminCommentController::class, 'show'])->name('dashboard.comment.show');

//Dashboard Posts Page -> Send update to the DB and show the post update
Route::put('/dashboard/post/{post}/comments/{comment}', [AdminCommentController::class, 'update'])->name('dashboard.comment.update');
